...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget _buildListView() {
    ...
    var _containerResultHeight = 95;

    var _listViewHeight = MediaQuery
        .of(context)
        .size
        .height - (MediaQuery
        .of(context)
        .padding
        .top + _appBarHeight + _containerResultHeight);
          ...
          Container(
            ...
            child: Center(
              child: Text(
                '\$${context
                    .read<CartItem>()
                    .productList[index].price.toStringAsFixed(1)}',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Total: \$${(context
                        .read<CartItem>()
                        .productList[index].totalPrice).toStringAsFixed(1)}',
                    style: const TextStyle(
                      fontSize: 15,
                      color: Colors.grey,
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    _containerResult = _buildContainerResult();
